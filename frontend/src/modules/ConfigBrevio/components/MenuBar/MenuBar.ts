...
import {
  useMenuBravioStore,
} from '../../stores/useMenuBravioStore'
...
export default defineComponent({
  ...
  setup() {
    ...
    const selectedKeysArray = computed(() =>
      [menuBravioStore.selectedKeys.textToolBox, menuBravioStore.selectedKeys.configuration].filter(
        Boolean,
      ),
    )
    ...
    const openNotificationWithIcon = () => {
      notification['info']({
        message: 'Tool Box',
        description: `${selectedKeysNames[menuBravioStore.combinedSelectedKeys[0]]} selected`,
        placement: 'topRight',
      })
    }
        ...
        children: [
          {
            ...
            onClick: () => {
              menuBravioStore.toggleSelectKey(
                TextToolBoxKeys.textToolBoxToSummary,
          ...
          },
          {
            ...
            onClick: () => {
              menuBravioStore.toggleSelectKey(
                TextToolBoxKeys.textToolBoxToTranscription,
                MenuBravioKeys.textToolBox,
              )
              openNotificationWithIcon()
            },
          },
          {
            ...
            onClick: () => {
              menuBravioStore.toggleSelectKey(
                TextToolBoxKeys.textToolBoxToDocFile,
                MenuBravioKeys.textToolBox,
              )
              openNotificationWithIcon()
            },
        ...
        children: [
          {
            ...
            onClick: () =>
              menuBravioStore.toggleSelectKey(
                ConfigurationKeys.configurationLanguage,
                MenuBravioKeys.configuration,
              ),
          },
          {
            ...
            onClick: () =>
              menuBravioStore.toggleSelectKey(
                ConfigurationKeys.configurationModel,
                MenuBravioKeys.configuration,
              ),
          },
        ],

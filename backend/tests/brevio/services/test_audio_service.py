...
async def test_get_media_info_success(audio_service, caplog):
    ...
    with patch(
        "backend.brevio.services.audio_service.subprocess.run", return_value=mock_result
    ):
...
async def test_get_media_info_yt_success(audio_service, caplog):
    ...
    with patch(
        "backend.brevio.services.audio_service.yt_dlp.YoutubeDL", return_value=mock_ydl
    ):
...
async def test_get_media_info_exception(audio_service, caplog):
    ...
    with patch(
        "backend.brevio.services.audio_service.subprocess.run",
...
async def test_get_media_info_yt_exception(audio_service, caplog):
    ...
    with patch(
        "backend.brevio.services.audio_service.yt_dlp.YoutubeDL",

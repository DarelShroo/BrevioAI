...
async def test_download_success(yt_service):
    ...
    with patch('yt_dlp.YoutubeDL') as mock_yt:
        ...
        mock_instance.download.assert_called_once_with(["https://www.youtube.com/watch?v=dQw4w9WgXcQ"])
...
async def test_process_video(yt_service):
    ...
    with patch.object(yt_service, "download", new_callable=AsyncMock) as mock_download:
        ...
        mock_download.assert_called_once_with("https://www.youtube.com/watch?v=dQw4w9WgXcQ", "./backend/audios", None)
...
async def test_get_video_urls_from_playlist(yt_service):
    ...
    with patch('yt_dlp.YoutubeDL') as mock_yt:
        ...
        mock_instance.extract_info.assert_called_once_with("https://www.youtube.com/playlist?list=PL123", download=False)
...
async def test_get_media_duration_video(yt_service):
    ...
    with patch('yt_dlp.YoutubeDL') as mock_yt:
        ...
        assert result == {"durations": [{"url": "https://www.youtube.com/watch?v=abc", "duration": 300}]}

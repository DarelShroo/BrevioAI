...
class Generate:
    ...
    @overload
    async def organize_audio_files_into_folders(self) -> Dict[str, Any]:
        ...

    @overload
    async def organize_audio_files_into_folders(
        self, data: BrevioGenerate
    ) -> Dict[str, Any]:
        ...

    async def organize_audio_files_into_folders(
        self, data: Optional[BrevioGenerate] = None
    ) -> Dict[str, Any]:
        try:
            if data is None:
    ...
    async def _process_online_audio_data(
        ...
        async def process_video(index: int, video: MediaEntry) -> Dict[str, str]:
            try:
    ...
    async def _process_documents(
        ...
        ) -> Dict[str, str]:  # Specified task return type
            try:
                return await task
            except Exception as e:
    ...
    async def _process_single_document(
        ...
        document_path: str,
        _data: BrevioGenerate,
        current_folder_entry_id: Optional[str],
        _user_folder_id: Optional[str],
